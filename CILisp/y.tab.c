...
#line 1222 "y.tab.c" /* yacc.c:1646  */
  ...
  case 3:
#line 37 "l8t4.y" /* yacc.c:1646  */
    {
                              //printf("yacc: program expr\n"); 
                              //double tot = eval($2); // look at part 1 and part 3 to figure how to ahnge this stuff
                              //freeNode($2);
